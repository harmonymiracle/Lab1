...
public class MyGraph {
    ...
    public final String Get_Bridge(){
    	return m_bridge;
    }

    public final HashMap<String, MyValue> GetGraph(){
...
public final Bridge_Status queryBridgeWords(String word1, String word2) {
...
public final String generateNewText(String inputText){
...
public final String calShortestPath(String word1, String word2) {
	...
	while(visited.size() <= graph_cpy.size()){
		...
		//third: update all edge weight from v(word1) to u(un_found node)
...
public final boolean CheckValidity(char c){
...
public final Boolean showDirectedGraph(String graph_filename) {

	System.out.println(graph_filename);
	String cur_path = System.getProperty("user.dir");
	if(checkDotResult(graph_filename)) {
		File file = new File(cur_path + "\\" + graph_filename + ".png");
		try {
...
public final String TreatFile(String text){
